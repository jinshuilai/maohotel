...
<!-- left side start-->
    <div class="left-side sticky-left-side">
        ...
        <div class="logo">
            <a href="#"><img src="${path }/bssets/images/logo.png" alt=""></a>
        </div>

        <div class="logo-icon text-center">
            <a href="#"><img src="${path }/bssets/images/logo_icon.png" alt=""></a>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <div class="visible-xs hidden-sm hidden-md hidden-lg">
                <div class="media logged-user">
                    <img alt="" src="${path }/bssets/images/photos/user-avatar.png" class="media-object">
            ...
            <!--sidebar nav start-->
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li><a href="${path }/bssets/admin/toIndex.do"><i class="fa fa-home"></i> <span>首页</span></a></li>
                <li class="menu-list"><a href="#"><i class="fa fa-sitemap"></i> <span>分类管理</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="${path }/bssets/category/show.do"> 一级分类</a></li>
                        <li><a href="${path }/bssets/category/secondShow.do"> 二级分类</a></li>
                ...
                <li class="menu-list"><a href="#"><i class="fa fa-tasks"></i> <span>商品管理</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="${path }/bssets/item/product.do"> 商品录入/编辑</a></li>
                        <li><a href="${path }/bssets/item/saleProduct.do?showStatus=0"> 商品上下架/发布</a></li>
                        <li><a href="${path }/bssets/item/feature.do"> 属性管理</a></li>
                        <li><a href="${path }/bssets/item/brand.do"> 品牌管理</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href="#"><i class="fa fa-file-text-o"></i> <span>订单管理</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="grids.html"> 修改订单信息（未付款）</a></li>
						<li><a href="${path }/bssets/orders/show.do?type=1"> 发货（已付款）</a></li>
                    </ul>
                </li>
